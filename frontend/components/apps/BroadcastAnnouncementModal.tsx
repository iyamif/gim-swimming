...
export default function BroadcastAnnouncementModal({
  ...
  const presets: PresetTemplate[] = [
    ...
    },
    {
      ...
      title: "Sesi Pemantapan Teknik Renang",
      message:
      ...
      <div className="relative z-10 w-full max-w-xl bg-white rounded-3xl shadow-2xl border border-slate-100 overflow-hidden my-auto max-h-[92vh] flex flex-col">
        ...
        <div className="bg-gradient-to-r from-blue-600 via-indigo-600 to-cyan-600 p-5 sm:p-6 text-white relative shrink-0">
          <div className="flex items-start justify-between gap-3 relative z-10">
            <div className="flex items-center gap-3">
              <div className="flex h-11 w-11 items-center justify-center rounded-2xl bg-white/20 backdrop-blur-md border border-white/30 text-white shadow-sm">
                <Megaphone size={22} />
              </div>
              <div>
        ...
        <div className="p-5 sm:p-6 space-y-5 overflow-y-auto flex-1">
          ...
          <form onSubmit={handleSend} className="space-y-4">
            ...
            <div className="p-3 rounded-2xl bg-blue-50/70 border border-blue-100 flex items-start gap-2.5 text-[11px] text-blue-900">
