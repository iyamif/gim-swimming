          ...
          <div className="flex flex-col gap-4">
            ...
            <ul className="flex flex-col gap-4 text-sm text-slate-400">
              ...
              <li className="flex items-start gap-3">
                ...
                <span>Jl. Cempaka Putih Raya No. 12, Jakarta Pusat, DKI Jakarta</span>
              </li>
              ...
              <li className="flex items-center gap-3">
                ...
                <a href="mailto:info@gimswimming.com" className="hover:text-cyan-400 transition-colors duration-200">
                  info@gimswimming.com
                </a>
              </li>
