...
export default function Navbar() {
  ...
  return (
    <header className="fixed left-0 top-0 z-50 w-full border-b border-slate-100 bg-white/90 backdrop-blur-md pt-[max(0.35rem,env(safe-area-inset-top,0px))] transition-all">
